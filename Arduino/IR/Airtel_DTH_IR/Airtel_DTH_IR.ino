...
const microseconds_t repeat_DIGIT_00[] PROGMEM = { 417U, 278U, 167U, 278U, 167U, 611U, 167U, 611U, 167U, 278U, 167U, 778U, 167U, 611U, 167U, 278U, 167U, 278U, 167U, 611U, 167U, 611U, 167U, 444U, 167U, 611U, 167U, 278U, 167U, 278U, 167U, 278U, 167U, 278U, 167U};
...
static void sendRaw(const microseconds_t intro_P[], size_t lengthIntro, const microseconds_t repeat_P[],
             size_t lengthRepeat, frequency_t frequency, unsigned times, int code) {
...
void loop() {
    ...
    long times = 1; //Serial.parseInt();

  
//sendRaw(NULL, 0U, repeat_MUTE_TOGGLE, 36U, 36000U, times);
delay(3000);
Serial.println(F("Sending Command..."));
sendRaw(NULL, 0U, repeat_DIGIT_1, 36U, 36000U, times,1);
delay(1000);
sendRaw(NULL, 0U, repeat_DIGIT_3, 36U, 36000U, times,3);
delay(1000);
sendRaw(NULL, 0U, repeat_DIGIT_8, 36U, 36000U, times,8);
Serial.println(F("Command Sent..."));

delay(2000);

Serial.println(F("Sending Command..."));
sendRaw(NULL, 0U, repeat_DIGIT_2, 36U, 36000U, times,2);
delay(1000);
sendRaw(NULL, 0U, repeat_DIGIT_8, 36U, 36000U, times,8);
Serial.println(F("Command Sent..."));
